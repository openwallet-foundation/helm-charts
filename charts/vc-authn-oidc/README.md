...
| `fullnameOverride`  | String to fully override the helm chart name, full prefix. *Must be provided if using | `""`                                        |
...
| `setNonRevoked`                                     | if True, the `non_revoked` attributed  will be added to each of the present-proof request  | `true`                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `invitationLabel`                                   | For the invitations sent that include the proof, what to add as the my_label field. Can be | `VC-AuthN`                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `useOobLocalDIDService`                             |                                                                                            | `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `walletDeepLinkPrefix`                              | URI scheme and host to use in deep links                                                   | `bcwallet://aries_proof-request`                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
| `controller.sessionTimeout.duration`                | The number of seconds an auth_sessions in the states defined in                            | `86400`                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| `controller.userVariableSubsitution`                | The placeholder for the user variable substitution file that can be used                   | `# This is a default placeholder Python file
...
| `controller.useConnectionBasedVerification`         | Whether to use connection-based proofs. If false connectionless OOB                        | `true`                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| `auth.token.privateKey.existingSecret`              | Specify the name of the secret containing the signing key to be                            | `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `database.existingSecret`                           | Specify existing secret containing the keys `mongodb-root-password`,                       | `""`                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `containerSecurityContext.readOnlyRootFilesystem`   | Set container's Security Context                                                           | `true`                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `containerSecurityContext.allowPrivilegeEscalation` | Set container's Security Context                                                           | `false`                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| `containerSecurityContext.capabilities.drop`        | List of capabilities to be dropped                                                         | `["ALL"]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `containerSecurityContext.seccompProfile.type`      | Set container's Security Context seccomp profile                                           | `RuntimeDefault`                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `networkPolicy.enabled`                             | Enable network policies                                                                    | `true`                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `networkPolicy.ingress.enabled`                     | Enable ingress rules                                                                       | `true`                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `networkPolicy.ingress.namespaceSelector`           | Namespace selector label that is allowed to access the                                     | `{}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `networkPolicy.ingress.podSelector`                 | Pod selector label that is allowed to access the Tenant proxy                              | `{}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `serviceAccount.annotations`                        | Annotations for service account. Evaluated as a template. Only used if `create`            | `{}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| `acapy.serviceAccount.annotations`                    | Annotations for service account. Evaluated as a template. Only used if       | `{}`                                |
| `acapy.serviceAccount.automountServiceAccountToken`   | Automount service account token for the server service                       | `true`                              |
| `acapy.serviceAccount.name`                           | Name of the service account to use. If not set and create is true, a name is | `""`                                |
...
| Name                                              | Description                                                               | Value              |
| ------------------------------------------------- | ------------------------------------------------------------------------- | ------------------ |
| `acapy.argfile.yml.admin-insecure-mode`           | Run the admin web server in insecure mode. DO NOT USE FOR PRODUCTION      | `false`            |
| `acapy.argfile.yml.auto-accept-invites`           | Automatically accept invites without firing a webhook event or            | `true`             |
| `acapy.argfile.yml.auto-accept-requests`          | Automatically accept connection requests without firing a webhook         | `true`             |
| `acapy.argfile.yml.auto-ping-connection`          | Automatically send a trust ping immediately after a connection            | `true`             |
| `acapy.argfile.yml.auto-provision`                | If the requested profile does not exist, initialize it with the given     | `true`             |
| `acapy.argfile.yml.auto-respond-credential-offer` | Automatically respond to Indy credential offers with a                    | `true`             |
| `acapy.argfile.yml.auto-respond-messages`         | Automatically respond to basic messages indicating the message was        | `true`             |
| `acapy.argfile.yml.auto-verify-presentation`      | Automatically verify a presentation when it is received.                  | `true`             |
| `acapy.argfile.yml.genesis-transactions-list`     | Load YAML configuration for connecting to multiple HyperLedger            | `/tmp/ledgers.yml` |
| `acapy.argfile.yml.log-level`                     | Specifies a custom logging level as one of: ('debug', 'info', 'warning',  | `info`             |
...
| `acapy.argfile.yml.public-invites`                | Send invitations out using the public DID for the agent, and receive      | `true`             |
| `acapy.argfile.yml.read-only-ledger`              | Sets ledger to read-only to prevent updates. Default: false.              | `true`             |
| `acapy.argfile.yml.wallet-local-did`              | If this parameter is set, provisions the wallet with a local DID from     | `true`             |
| `acapy.argfile.yml.wallet-name`                   | Specifies the wallet name to be used by the agent. This is useful if your | `askar-wallet`     |
| `acapy.argfile.yml.wallet-storage-type`           | Specifies the type of Indy wallet backend to use. Supported internal      | `postgres_storage` |
| `acapy.argfile.yml.wallet-type`                   | Specifies the type of Indy wallet provider to use. Supported internal     | `askar`            |
| `acapy.ledgers.yml`                               |                                                                           | `{}`               |
...
| `acapy.secrets.api.existingSecret`           | Name of an existing Secret providing API related keys. If set, the chart | `""`          |
...
| `acapy.secrets.api.secretKeys.webhookapiKey` | Key in the API secret holding the webhook API key (used when             | `webhookapi`  |
| `acapy.secrets.seed.retainOnUninstall`       | When true, adds helm.sh/resource-policy: keep to generated seed          | `true`        |
| `acapy.secrets.seed.existingSecret`          | Name of an existing Secret providing the wallet seed. If set, the chart  | `""`          |
...
| `acapy.networkPolicy.ingressNSMatchLabels` | Labels to match to allow traffic from other namespaces.               | `{}`                              |
...
| `mongodb.auth.existingSecret`                | Existing secret with MongoDB(&reg;) credentials (keys: `mongodb-passwords`, | `{{ include "global.fullname" . }}` |
...
| `mongodb.commonLabels`                       | Add labels to all the deployed resources (sub-charts are not considered).   | `{}`                                |
...
| `redis.resources.limits.cpu`                              | CPU limit for Redis containers                         | `100m`         |
| `redis.resources.limits.memory`                           | Memory limit for Redis containers                      | `128Mi`        |
| `redis.resources.requests.cpu`                            | CPU request for Redis containers                       | `50m`          |
| `redis.resources.requests.memory`                         | Memory request for Redis containers                    | `64Mi`         |
| `redis.nodeSelector`                                      | Node labels for Redis pods assignment                  | `{}`           |
| `redis.tolerations`                                       | Tolerations for Redis pods assignment                  | `[]`           |
| `redis.securityContext.enabled`                           | Enable Redis pods' Security Context                    | `true`         |
| `redis.securityContext.runAsUser`                         | Set Redis pods' Security Context runAsUser             | `999`          |
| `redis.securityContext.runAsNonRoot`                      | Set Redis pods' Security Context runAsNonRoot          | `true`         |
| `redis.securityContext.fsGroup`                           | Set Redis pods' Security Context fsGroup               | `999`          |
| `redis.containerSecurityContext.enabled`                  | Enable Redis containers' Security Context              | `true`         |
| `redis.containerSecurityContext.runAsUser`                | Set Redis containers' Security Context runAsUser       | `999`          |
| `redis.containerSecurityContext.runAsNonRoot`             | Set Redis containers' Security Context runAsNonRoot    | `true`         |
| `redis.containerSecurityContext.allowPrivilegeEscalation` | Set Redis containers' Security Context                 | `false`        |
| `redis.containerSecurityContext.readOnlyRootFilesystem`   | Set Redis containers' Security Context                 | `true`         |
| `redis.containerSecurityContext.capabilities.drop`        | List of capabilities to be dropped in Redis containers | `["ALL"]`      |

### External Redis Configuration

| Name                                | Description                                                           | Value   |
| ----------------------------------- | --------------------------------------------------------------------- | ------- |
| `externalRedis.host`                | External Redis host. When set, the chart will use this instead of the | `""`    |
...
| `externalRedis.auth.existingSecret` | Name of existing secret containing Redis password.                    | `""`    |
| `externalRedis.auth.password`       | Redis password. Ignored if existingSecret is set.                     | `""`    |
