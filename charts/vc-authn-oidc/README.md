...
| Name                                             | Description                                                                                                                                                                                                         | Value              |
| ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ |
| `externalMongodb.enabled`                        | Enable external MongoDB. When true, the bundled MongoDB subchart is disabled and the chart connects to the specified external MongoDB instance. Cannot be used together with mongodb subchart (mutually exclusive). | `false`            |
| `externalMongodb.host`                           | External MongoDB host (e.g., "mongodb.example.com" or "mongodb-0.mongodb-headless.namespace.svc.cluster.local")                                                                                                     | `""`               |
