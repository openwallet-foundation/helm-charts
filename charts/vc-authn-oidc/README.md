...
| `acapy.image.tag`                                     | Overrides the image tag which defaults to the chart appVersion.                                                     | `2.4.1`                                           |
...
| `mongodb.image.tag`                          | MongoDB image tag                                                                                                            | `8.3.2`                                   |
...
| `mongodb.customUsers`                        | Custom MongoDB users to provision. Defaults to the `vcauthn` app user; keep                                                  | `[]`                                      |
